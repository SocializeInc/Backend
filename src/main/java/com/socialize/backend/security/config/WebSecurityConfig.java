package com.socialize.backend.security.config;

import com.socialize.backend.security.jwt.AuthEntryPointJwt;
import com.socialize.backend.security.jwt.AuthTokenFilter;
import com.socialize.backend.security.jwt.JwtUtils;
import com.socialize.backend.security.service.UserDetailsServiceImpl;
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers("/socialize/api/auth/**").permitAll()
                                ...
                                .requestMatchers("/socialize/api/messages/**").permitAll()
